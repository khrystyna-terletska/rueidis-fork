...
func TestNewLuaScript_MayRetryable(t *testing.T) {
	...
	eval := func(readOnly, retryable bool) expect {
		cmd := "EVAL"
		if readOnly {
			cmd = "EVAL_RO"
		}
	...
	genExpects := func(fn ...func(readOnly, retryable bool) expect) []func(readOnly, retryable bool) expect { return fn }
